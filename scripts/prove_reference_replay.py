...
def run_once(*, fixture_dir: Path, run_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "topology_proof_passed": decoded["topology_proof"]["passed"],
        "topology_proof_count": decoded["topology_proof"]["proof_count"],
...
def proof(work_dir: Path) -> dict[str, Any]:
    ...
    easy_change_checks = {
        ...
        "changed_decode_passed": changed["ledger_hash_chain_valid"] and changed["compatibility_passed"] and changed["topology_proof_passed"] and changed["all_questions_answered"],
    }
    health_checks = {
        "base_decode_passed": base_a["ledger_hash_chain_valid"] and base_a["compatibility_passed"] and base_a["topology_proof_passed"] and base_a["all_questions_answered"],
        "base_replay_decode_passed": base_b["ledger_hash_chain_valid"] and base_b["compatibility_passed"] and base_b["topology_proof_passed"] and base_b["all_questions_answered"],
    ...
    return {
        ...
        "claim_boundary": "OpenEncoder client encode/decode replay, signed-int16 typed-atom parity, and local answer fidelity receipt only. Groth16 is the only proof-verification path and is covered by docs/proofs/groth16_verification_proof.json.",
        "encoder": {
